...
public class ClassfinderQuery {
	...
	public List<String> getAcademicWeeks() {
		...
		int startWeekNumber = startDate.get(weekFields.weekOfWeekBasedYear());
		int endWeekNumber = endDate.get(weekFields.weekOfWeekBasedYear());
	...
	public String toString() {
		...
		String type = classroomType.equals(ClassroomType.LABORATORY) ? "L" : "T";

		String result = String.format(format, startDate.format(formatter), endDate.format(formatter),
				startTime.getHour(), startTime.getMinute(), endTime.getHour(), endTime.getMinute(), durationInHours,
